...
final class Strings {
    ...
    // collection names
    public static var STUDENT:String = "Student"
    public static var PARENT:String = "Parent"
    public static var TEACHER:String = "Teacher"
    public static var ASSIGNMENT:String = "Assignment"
    public static var CLASS:String = "Class"
    public static var EMERGENCY_CONTACT:String = "EmergencyContact"
    
    // fields
    
    public static var FIRST_NAME:String = "firstName"
    public static var LAST_NAME:String = "lastName"
